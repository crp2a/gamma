...
(spc1 <- calibrateEnergy(tka_spc, lines = calib_lines))
### Inspect results
...
peaks <- fitPeaks(tka_spc, peaks = c(84, 496, 876), scale = "chanel")
### Inspect results
plot(peaks)
### Correct the energy scale
(spc2 <- calibrateEnergy(peaks, lines = c(238, 1461, 2614.5)))
### Inspect results
