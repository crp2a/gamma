...
[![CRAN checks](https://cranchecks.info/badges/worst/gamma)](https://cran.r-project.org/web/checks/check_results_gamma.html){.pkgdown-release}
...
Or install the development version from [R-universe](https://crp2a.r-universe.dev/) with:
