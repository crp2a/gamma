...
# BDX200_data <- rbind.data.frame(BDX200_data,
#                                 ZERO = list("ZERO", 0, 0, 0, 0, 0))
usethis::use_data(BDX200_data, internal = FALSE, overwrite = FALSE)

## Linear regression
# Build calibration curve
BDX200_curve <- .CalibrationCurve(
  model = lm(dose_value ~ signal_value, data = BDX200_data),
...
usethis::use_data(BDX200_curve, internal = FALSE, overwrite = FALSE)
