...
test_dose <- predict(BDX1, test_scaled)
...
```{r integrate-diff, echo=FALSE, fig.width=7, fig.height=3.5, fig.align="center"}
...
test_diff <- test_dose %>%
  ...
  dplyr::mutate(signal_diff = ((signal_value - signal_old) / signal_old) * 100,
                dose_diff = ((dose_value - dose_old) / dose_old) * 100)
