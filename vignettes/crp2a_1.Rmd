...
calib_dir <- system.file("extdata/BDX_LaBr_1/calibration", package = "gamma")
...
#### BRIQUE
```{r calibrate-BRIQUE}
plot(calib_spc[["BRIQUE"]], xaxis = "chanel", yaxis = "rate") +
...
BRIQUE_calib <- calibrate_energy(calib_spc[["BRIQUE"]], lines = lines)
...
# Display curve data
knitr::kable(BDX_LaBr_1_data, row.names = FALSE)
```

```{r lm-summary_Ni, echo=FALSE}
summary(get_model(BDX_LaBr_1_curve, "Ni"))
```

```{r lm-summary_NiEi, echo=FALSE}
summary(get_model(BDX_LaBr_1_curve, "NiEi"))
```
