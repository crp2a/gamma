...
```{r calibrate}
spc_adjust <- calibrateEnergy(spc, lines = c(238, 1461, 2614.5))
...
# Calibrate energy scale
calib_scale <- calibrateEnergy(spc_calib, lines = c(238, 1461, 2614.5))
...
# Calibrate energy scale
spc_scale <- calibrateEnergy(spc, lines = c(238, 1461, 2614.5))

# Estimate dose rate
dose_rate <- estimateDoseRate(calib_scale, calib_curve, 
                              noise = list(value = 1190, error = 1),
                              span = 20)
