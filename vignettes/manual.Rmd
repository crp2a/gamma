...
# Detect peaks
peak_index <- findPeaks(spc_clean1)
...
peak_fit_energy <- fitPeaks(spc_clean1, peaks = c(238, 1461, 2614.5), 
                            scale = "energy")

plot(peak_fit_energy) +
  ggplot2::labs(title = "Fixed peak positions (keV)",
                x = "Energy [keV]", y = "Count") +
  ggplot2::theme_bw()
